            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="header"  class="section-title mb-0">
                        <h4 class="m-0 text-black-0  font-weight-bold">Differently Abled Christins</h4>
                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="container text-center">
                                <div class="row align-items-start">
                                    <div class="col">
                                        <img class="img-fluid"  src="./img/E20v6p2WEAEzDS1.jpeg" style="height: 400px;width: 800px" >
                                    </div>
