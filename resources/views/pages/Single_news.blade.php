...
{{--                </div>--}}
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-3">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Also Read</h4>
                    </div>
                    @foreach($read_also as $News)
                    <div class="bg-white border border-top-0 p-3">
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" style="width:100px" src="NewsImages/{{$News->img_5}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
{{--                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href="">Business</a>--}}
{{--                                    <a class="text-body" href=""><small>Jan 01, 2045</small></a>--}}
                                </div>
                                <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="/{{$News['id']}}"><h6>{{$News->title}}</h6></a>
                            </div>
                        </div>
